...
<@layout.layout 4>
    ...
    <div class="am-modal am-modal-no-btn" id="form-modal">
        <div class="am-modal-dialog">
            <div class="am-modal-hd">商品属性信息
                <a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
            </div>
            <div class="am-modal-bd">
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <form class="am-form am-form-horizontal" id="attribute-form" data-am-validator>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-12">
                                    <button type="button" class="am-btn am-btn-success" onclick="saveProductAttribute()">保存</button>
    ...
    <script>
        $(function () {
            ...
            $('#sampleTable').dataTable({
                ...
                'ordering': false,
                'ajax': {
                    url: '${ctx}/product/selectAllProductAttribute.do',
                    type: "POST"
                },
                'columns': [
                    {'data': null},
                    ...
                    {'data': 'name'},
                    {
                        'data':
                                function (row) {
                                    return '<button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="deleteProductAttribute('+row.id+')"><span class="am-icon-trash-o"></span> 删除</button>';
                                }
                    }
                ],
        ...
        function saveProductAttribute(){
            ...
            if(isValidator){
                $form.ajaxSubmit({
                    url: '${ctx}/product/saveProductAttribute.do',
                    type: 'POST',
                    dataType: 'json',
                    success: function (res) {
                        if (res.code === 200) {
        ...
        function deleteProductAttribute(id){
            ...
            $model.modal({
                ...
                onConfirm: function() {
                    $.ajax({
                        url: '${ctx}/product/deleteProductAttribute.do',
                        type: 'POST',
                        data: {
                            id: id
                        },
